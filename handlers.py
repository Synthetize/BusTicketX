...
async def start(update: Update, context: CallbackContext) -> int:
    await update.message.reply_text(
        "Hello! I need to collect some information to start buying bus tickets."
    )

    await update.message.reply_text(
        "If you already have information saved, you can start by typing /cancel. Please tell me your name."
    )
...
async def confirm(update: Update, context: CallbackContext) -> int:
    if update.message.text.lower() == "yes":
        ...
        save_users(users)
        await update.message.reply_text("Your data has been saved in the JSON file. ✅",
